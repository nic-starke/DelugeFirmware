...
void MenuItemPatchedParam::drawValue() {
  ...
  uint8_t drawDot = soundEditor.currentParamManager->getPatchCableSet()
...
void MenuItemPatchedParamInteger::readCurrentValue() {
  soundEditor.currentValue =
      (((int64_t)soundEditor.currentParamManager->getPatchedParamSet()->getValue(getP()) +
        2147483648) *
           50 +
       2147483648) >>
      32;
...
void MenuItemPatchedParamInteger::writeCurrentValue() {
  ...
  //((ParamManagerBase*)soundEditor.currentParamManager)->setPatchedParamValue(getP(),
  // getFinalValue(), 0xFFFFFFFF, 0, soundEditor.currentSound, currentSong,
  // currentSong->currentClip, true, true);
}
...
void MenuItemPatchedParamPan::readCurrentValue() {
  soundEditor.currentValue =
      ((int64_t)soundEditor.currentParamManager->getPatchedParamSet()->getValue(getP()) * 64 +
       2147483648) >>
      32;
}
