...
struct ConnectedUSBMIDIDevice {
  ...
  uint8_t  numBytesSendingNow; // This will show a value after the general flush
                               // function is called, throughout other Devices
                               // being sent to before this one, and until we've
                               // completed our send
};
