...
extern uint8_t imageStore[displayHeight * 2][displayWidth + sideBarWidth]
                         [3]; // 255 = full brightness
extern uint8_t occupancyMaskStore[displayHeight * 2]
                                 [displayWidth + sideBarWidth]; // 64 = full occupancy
...
void        renderZoomedSquare(int32_t      outputSquareStartOnOutImage,
                               int32_t      outputSquareEndOnOutImage,
                               uint32_t     outImageTimesBigerThanNormal,
...
void timerRoutine();
void copyBetweenImageStores(uint8_t* dest,
                            uint8_t* source,
                            int      destWidth,
                            int      sourceWidth,
                            int      copyWidth);
