...
/*
 * Portions of this code initially copied from the relevant sample code by
 * Renesas.
 */
...
uint8_t* g_midi_string_table[] = {g_midi_string0,
                                  g_midi_string1,
                                  g_midi_string2,
                                  g_midi_string3,
                                  g_midi_string4};
