...
public:
  ...
  uint8_t getPatchCableIndex(uint8_t                              from,
                             ParamDescriptor                      destinationParamDescriptor,
  ...
  AutoParam* getParam(ModelStackWithParamCollection const* modelStack,
                      int                                  s,
                      ParamDescriptor                      destinationParamDescriptor,
  ...
  bool    isSourcePatchedToDestinationDescriptorVolumeInspecific(
         int             s,
         ParamDescriptor destinationParamDescriptor);
