...
// This is virtual. Some classes with override it and generate some name on the
// fly. Supplied buffer size must be MENU_ITEM_TITLE_BUFFER_SIZE. Actual max num
// chars for OLED display is 14. May return pointer to that buffer, or to some
