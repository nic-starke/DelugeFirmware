...
/*
 * Basic code initially copied from
...
// Make sure numElements isn't 0 before you call this! And you should also make
// sure it's not just 1 before you bother calling.
