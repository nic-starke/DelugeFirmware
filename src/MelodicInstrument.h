...
public:
  ...
  // mpeValues must be provided for a note-on (can be 0s). Otherwise, can be
  // NULL pointer
  virtual void sendNote(ModelStackWithThreeMainThings* modelStack,
                        bool                           isOn,
                        int                            noteCode,
  ...
  virtual void
  ccReceivedFromInputMIDIChannel(int cc, int value, ModelStackWithTimelineCounter* modelStack) {}
  ...
  void offerReceivedNote(ModelStackWithTimelineCounter* modelStackWithTimelineCounter,
                         ...
                         bool*                          doingMidiThru);
  void offerReceivedPitchBend(ModelStackWithTimelineCounter* modelStackWithTimelineCounter,
                              MIDIDevice*                    fromDevice,
                              uint8_t                        channel,
                              uint8_t                        data1,
                              uint8_t                        data2,
                              bool*                          doingMidiThru);
  void offerReceivedCC(ModelStackWithTimelineCounter* modelStackWithTimelineCounter,
                       MIDIDevice*                    fromDevice,
                       uint8_t                        channel,
                       uint8_t                        ccNumber,
                       uint8_t                        value,
                       bool*                          doingMidiThru);
  void offerReceivedAftertouch(ModelStackWithTimelineCounter* modelStackWithTimelineCounter,
                               MIDIDevice*                    fromDevice,
                               int                            channel,
                               int                            value,
                               int                            noteCode,
  ...
  void beginAuditioningForNote(ModelStack*    modelStack,
                               int            note,
                               int            velocity,
                               int16_t const* mpeValues,
                               int            fromMIDIChannel  = MIDI_CHANNEL_NONE,
  ...
  virtual ModelStackWithAutoParam*
       getParamToControlFromInputMIDIChannel(int cc, ModelStackWithThreeMainThings* modelStack);
  void processParamFromInputMIDIChannel(int                            cc,
                                        int32_t                        newValue,
                                        ModelStackWithTimelineCounter* modelStack);

  void polyphonicExpressionEventPossiblyToRecord(ModelStackWithTimelineCounter* modelStack,
                                                 int32_t                        newValue,
  ...
  virtual void polyphonicExpressionEventOnChannelOrNote(int newValue,
                                                        int whichExpressionDimension,
                                                        int channelOrNoteNumber,
                                                        int whichCharacteristic) = 0;

  void offerBendRangeUpdate(ModelStack* modelStack,
                            MIDIDevice* device,
                            int         channelOrZone,
                            int         whichBendRange,
                            int         bendSemitones);
