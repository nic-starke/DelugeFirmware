...
public:
  String();
  // String(String* otherString); // BEWARE - using this on stack instances
  // sometimes just caused crashes and stuff. Made no sense. Instead,
  // constructing then calling set() works
  ~String();
