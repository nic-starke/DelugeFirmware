...
public:
  ...
  void                     setupFilterSetConfig(FilterSetConfig* filterSetConfig,
  ...
  void processFXForGlobalEffectable(StereoSample*      inputBuffer,
                                    int                numSamples,
                                    int32_t*           postFXVolume,
                                    ParamManager*      paramManager,
  ...
  void        setupDelayWorkingState(DelayWorkingState* delayWorkingState,
                                     ParamManager*      paramManager,
