...
public:
  ...
  // In samples.
  uint64_t startPos;
  uint64_t endPos; // Don't access this directly. Call getPos(). This variable
                   // may be beyond the end of the sample
...
protected:
  void         claimClusterReasonsForMarker(Cluster** clusters,
