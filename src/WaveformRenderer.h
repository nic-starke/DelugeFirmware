...
public:
  ...
  bool renderFullScreen(Sample*             sample,
                        uint64_t            xScroll,
                        uint64_t            xZoom,
  ...
  bool renderAsSingleRow(Sample*             sample,
                         int64_t             xScroll,
                         uint64_t            xZoom,
                         uint8_t*            thisImage,
                         WaveformRenderData* data,
                         ...
                         int                 xStart,
                         int                 xEnd);
  void renderOneCol(Sample*             sample,
                    int                 xDisplay,
                    uint8_t             thisImage[][displayWidth + sideBarWidth][3],
                    WaveformRenderData* data,
                    bool                reversed = false,
                    uint8_t             rgb[]    = NULL);
  void renderOneColForCollapseAnimation(int     xDisplay,
                                        int     xDisplayOutput,
                                        ...
                                        int32_t             valueSpan);
  void
       renderOneColForCollapseAnimationZoomedOut(int     xDisplayWaveformLeftEdge,
                                                 ...
                                                 int32_t             valueCentrePoint,
                                                 int32_t             valueSpan);
  bool findPeaksPerCol(Sample*             sample,
                       int64_t             xScroll,
                       uint64_t            xZoom,
                       WaveformRenderData* data,
                       SampleRecorder*     recorder = NULL,
...
private:
  ...
  void getColBarPositions(int                 xDisplay,
                          WaveformRenderData* data,
                          int32_t*            min24,
                          int32_t*            max24,
                          int32_t             valueCentrePoint,
                          int32_t             valueSpan);
  void drawColBar(int     xDisplay,
                  int32_t min24,
                  int32_t max24,
                  uint8_t thisImage[][displayWidth + sideBarWidth][3],
                  int     brightness = 128,
                  uint8_t rgb[]      = NULL);
  void
  renderOneColForCollapseAnimationInterpolation(int     xDisplayOutput,
                                                int32_t min24,
                                                int32_t max24,
