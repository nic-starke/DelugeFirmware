...
public:
  FilterSet();
  void renderLPFLong(int32_t*         outputSample,
                     int32_t*         endSample,
  ...
  void renderHPFLong(int32_t*         outputSample,
                     int32_t*         endSample,
                     FilterSetConfig* filterSetConfig,
                     int              numSamples,
                     int              sampleIncrement = 1);
  ...
  inline void renderLong(int32_t*         outputSample,
                         int32_t*         endSample,
                         FilterSetConfig* filterSetConfig,
                         uint8_t          lpfMode,
                         int              numSamples,
...
private:
  ...
  int32_t
  doDriveLPFOnSample(int32_t input, FilterSetConfig* filterSetConfig, int extraSaturation = 0);
};
