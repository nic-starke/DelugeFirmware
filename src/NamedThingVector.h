...
public:
  ...
  } // Empty, but must call this so that the String's destructor is also called
  void*  namedThing;
  String name; // Store this here so we don't have to go follow the Sample's
               // pointer first to find this out
};

// Note: these are currently non-destructible. If you do destruct, well
// currently it doesn't destruct all the Strings in the Elements!
