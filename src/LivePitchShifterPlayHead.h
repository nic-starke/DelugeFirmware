...
public:
  ...
  ~LivePitchShifterPlayHead();
  void render(int32_t* outputBuffer,
              int      numSamples,
              int      numChannels,
  ...
  int  getEstimatedPlaytimeRemaining(uint32_t         repitchedBufferWritePos,
                                     LiveInputBuffer* liveInputBuffer,
                                     int32_t          phaseIncrement);

  int getNumRawSamplesBehindInput(LiveInputBuffer*  liveInputBuffer,
