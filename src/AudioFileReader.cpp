...
// One limitation of this function is that it can never read the final byte of
// the file. Not a problem for us
int AudioFileReader::readBytes(char* outputBuffer, int num) {
  if ((uint32_t)(getBytePos() + num) > fileSize) { return ERROR_FILE_CORRUPTED; }
