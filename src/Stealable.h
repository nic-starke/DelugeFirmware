...
// Please see explanation of memory allocation and "stealing" at the top of
// GeneralMemoryAllocator.h

class Stealable : public BidirectionalLinkedListNode {
public:
  Stealable();
  virtual bool mayBeStolen(void* thingNotToStealFrom) = 0;
  virtual void steal(char const* errorCode)           = 0; // You gotta also call the
                                                           // destructor after this.
