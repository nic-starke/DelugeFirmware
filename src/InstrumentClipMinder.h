...
// This class performs operations on an InstrumentClip that are common to both
// the InstrumentClipView and KeyboardView.
...
public:
  ...
  static int16_t defaultRootNote; // Stores the calculated "default" root note between the
                                  // user pressing the scale-mode button and releasing it
