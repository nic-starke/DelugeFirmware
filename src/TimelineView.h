...
public:
  ...
  virtual bool         calculateZoomPinSquares(uint32_t oldScroll,
                                               uint32_t newScroll,
                                               uint32_t newZoom,
  ...
  } // SessionView doesn't have this because it does this a different way.
  ...
  void displayNumberOfBarsAndBeats(uint32_t    number,
