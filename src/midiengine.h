...
public:
  ...
  void sendMidi(uint8_t statusType,
                uint8_t channel,
                uint8_t data1   = 0,
                uint8_t data2   = 0,
  ...
  LearnedMIDI
      globalMIDICommands[NUM_GLOBAL_MIDI_COMMANDS]; // If bit "16" (actually bit 4) is 1, this is
                                                    // a program change. (Wait, still?)
...
private:
  ...
  void midiMessageReceived(MIDIDevice* fromDevice,
                           uint8_t     statusType,
                           uint8_t     channel,
                           uint8_t     data1,
                           uint8_t     data2,
