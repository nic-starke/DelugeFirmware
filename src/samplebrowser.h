...
public:
  ...
  int  timerCallback();
  bool claimCurrentFile(int mayDoPitchDetection = 1,
...
private:
  ...
  bool loadAllSamplesInFolder(bool      detectPitch,
                              int*      getNumSamples,
                              Sample*** getSortArea,
  ...
  bool qwertyCurrentlyDrawnOnscreen; // This will linger as true even when
                                     // qwertyVisible has been set to false
};
