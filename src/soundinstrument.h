...
public:
  ...
  bool offerReceivedPitchBendToLearnedParams(MIDIDevice*                    fromDevice,
                                             ...
                                             uint8_t                        data2,
                                             ModelStackWithTimelineCounter* modelStack) {
    return Sound::offerReceivedPitchBendToLearnedParams(fromDevice,
                                                        channel,
                                                        data1,
                                                        data2,
                                                        modelStack);
  ...
  void polyphonicExpressionEventOnChannelOrNote(int newValue,
  ...
  void sendNote(ModelStackWithThreeMainThings* modelStack,
                bool                           isOn,
                int                            noteCode,
