...
// This one is "absolute" - if song's insideWorldTickMagnitude changes, such a
// param's text value will display as a different one, but the music will sound
// the same
...
// This one is "relative to the song". In that it'll show its text value to the
// user, e.g. "16ths", regardless of any song variables, and then when its value
// gets used for anything, it'll be transposed into the song's magnitude by
