...
// Ok, creating a class for this is absolutely stupid, but I was a noob at the
// time! It doesn't add any performance overhead though.
...
public:
  ...
  inline void addPannedStereo(int32_t sampleValueL,
                              int32_t sampleValueR,
                              int32_t amplitudeL,
                              int32_t amplitudeR) {
