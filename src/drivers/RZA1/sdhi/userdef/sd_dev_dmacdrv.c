 ...
 * Return Value :
 ******************************************************************************/
void sd_DMAC_PeriReqInit(const dmac_transinfo_t* trans_info,
                         uint32_t                dmamode,
                         uint32_t                continuation,
                         uint32_t                request_factor,
                         uint32_t                req_direction,
                         int                     dma_channel) {
  if (DMAC_MODE_REGISTER == dmamode) {
    ...
    RZA_IO_RegWrite_32(&DMACn(dma_channel).CHCFG_n, 0, DMAC1_CHCFG_n_DMS_SHIFT, DMAC1_CHCFG_n_DMS);
    RZA_IO_RegWrite_32(&DMACn(dma_channel).CHCFG_n,
                       0,
                       DMAC1_CHCFG_n_RSEL_SHIFT,
                       DMAC1_CHCFG_n_RSEL);
    RZA_IO_RegWrite_32(&DMACn(dma_channel).CHCFG_n, 0, DMAC1_CHCFG_n_SBE_SHIFT, DMAC1_CHCFG_n_SBE);
    RZA_IO_RegWrite_32(&DMACn(dma_channel).CHCFG_n, 0, DMAC1_CHCFG_n_DEM_SHIFT, DMAC1_CHCFG_n_DEM);
    ...
    RZA_IO_RegWrite_32(&DMACn(dma_channel).CHCFG_n, 0, DMAC1_CHCFG_n_TM_SHIFT, DMAC1_CHCFG_n_TM);
    RZA_IO_RegWrite_32(&DMACn(dma_channel).CHCFG_n,
                       dma_channel & 0b111,
...
int32_t sd_DMAC_Open(uint32_t req, int dma_channel) {
  ...
  doAnyway:
    ...
    // Hack - just go and do it anyway. This helps the case where the SD has
    // been re-inserted after being ripped out during a transfer
    goto doAnyway;
    ret = -1;
  }
...
int32_t sd_DMAC_Get_Endflag(int dma_channel) {
  if (RZA_IO_RegRead_32(&DMACn(dma_channel).CHSTAT_n, DMAC2_CHSTAT_n_TC_SHIFT, DMAC2_CHSTAT_n_TC) ==
      0) {
    /* not yet */
    return 0;
  }
