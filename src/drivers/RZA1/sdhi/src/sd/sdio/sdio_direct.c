 ...
 * Include      :
 * Declaration  : int sdio_read_direct(int sd_port, unsigned char *buff,unsigned
 *long func,unsigned long adr); Functions    : direct read io register from
 *specified address (=adr) : using CMD52 Argument     : unsigned char *buff :
 *data buffer : unsigned long func : access function number : unsigned long adr
 *: access register address Return       : SD_OK : end of succeed : SD_ERR: end
 *of error Remark       :
 *****************************************************************************/
 ...
 * Include      :
 * Declaration  : int sdio_write_direct(int sd_port, unsigned char
 **buff,unsigned long func,unsigned long adr,unsigned long raw_flag); Functions
 *: direct write io register from specified address (=adr) : using CMD52
 ...
 * Remark       :
 *****************************************************************************/
int sdio_write_direct(int            sd_port,
                      unsigned char* buff,
                      unsigned long  func,
                      unsigned long  adr,
...
int _sdio_direct(SDHNDL*        hndl,
  ...
  /* issue CMD */
  if (_sd_send_iocmd(hndl, cmd, arg) != SD_OK) { return hndl->error; }
