...
#define ETHER_FROM_TSU_ADRH0_ARRAY_ADDRESS_LIST                                                 \
  { /* ->MISRA 11.3 */ /* ->SEC R2.7.1 */                                                       \
    &ETHER_FROM_TSU_ADRH0, &ETHER_FROM_TSU_ADRH1, &ETHER_FROM_TSU_ADRH2, &ETHER_FROM_TSU_ADRH3, \
        &ETHER_FROM_TSU_ADRH4, &ETHER_FROM_TSU_ADRH5, &ETHER_FROM_TSU_ADRH6,                    \
        &ETHER_FROM_TSU_ADRH7, &ETHER_FROM_TSU_ADRH8, &ETHER_FROM_TSU_ADRH9,                    \
        &ETHER_FROM_TSU_ADRH10, &ETHER_FROM_TSU_ADRH11, &ETHER_FROM_TSU_ADRH12,                 \
        &ETHER_FROM_TSU_ADRH13, &ETHER_FROM_TSU_ADRH14, &ETHER_FROM_TSU_ADRH15,                 \
        &ETHER_FROM_TSU_ADRH16, &ETHER_FROM_TSU_ADRH17, &ETHER_FROM_TSU_ADRH18,                 \
        &ETHER_FROM_TSU_ADRH19, &ETHER_FROM_TSU_ADRH20, &ETHER_FROM_TSU_ADRH21,                 \
        &ETHER_FROM_TSU_ADRH22, &ETHER_FROM_TSU_ADRH23, &ETHER_FROM_TSU_ADRH24,                 \
        &ETHER_FROM_TSU_ADRH25, &ETHER_FROM_TSU_ADRH26, &ETHER_FROM_TSU_ADRH27,                 \
        &ETHER_FROM_TSU_ADRH28, &ETHER_FROM_TSU_ADRH29, &ETHER_FROM_TSU_ADRH30,                 \
        &ETHER_FROM_TSU_ADRH31                                                                  \
  } /* <-MISRA 11.3 */ /* <-SEC R2.7.1 */ /* { } is for MISRA 19.4 */
#define ETHER_FROM_TSU_ADRH0 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH0) /* ETHER_FROM_TSU_ADRH0 */
#define ETHER_FROM_TSU_ADRH1 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH1) /* ETHER_FROM_TSU_ADRH1 */
#define ETHER_FROM_TSU_ADRH2 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH2) /* ETHER_FROM_TSU_ADRH2 */
#define ETHER_FROM_TSU_ADRH3 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH3) /* ETHER_FROM_TSU_ADRH3 */
#define ETHER_FROM_TSU_ADRH4 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH4) /* ETHER_FROM_TSU_ADRH4 */
#define ETHER_FROM_TSU_ADRH5 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH5) /* ETHER_FROM_TSU_ADRH5 */
#define ETHER_FROM_TSU_ADRH6 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH6) /* ETHER_FROM_TSU_ADRH6 */
#define ETHER_FROM_TSU_ADRH7 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH7) /* ETHER_FROM_TSU_ADRH7 */
#define ETHER_FROM_TSU_ADRH8 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH8) /* ETHER_FROM_TSU_ADRH8 */
#define ETHER_FROM_TSU_ADRH9 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH9) /* ETHER_FROM_TSU_ADRH9 */
#define ETHER_FROM_TSU_ADRH10 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH10) /* ETHER_FROM_TSU_ADRH10 */
#define ETHER_FROM_TSU_ADRH11 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH11) /* ETHER_FROM_TSU_ADRH11 */
#define ETHER_FROM_TSU_ADRH12 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH12) /* ETHER_FROM_TSU_ADRH12 */
#define ETHER_FROM_TSU_ADRH13 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH13) /* ETHER_FROM_TSU_ADRH13 */
#define ETHER_FROM_TSU_ADRH14 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH14) /* ETHER_FROM_TSU_ADRH14 */
#define ETHER_FROM_TSU_ADRH15 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH15) /* ETHER_FROM_TSU_ADRH15 */
#define ETHER_FROM_TSU_ADRH16 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH16) /* ETHER_FROM_TSU_ADRH16 */
#define ETHER_FROM_TSU_ADRH17 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH17) /* ETHER_FROM_TSU_ADRH17 */
#define ETHER_FROM_TSU_ADRH18 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH18) /* ETHER_FROM_TSU_ADRH18 */
#define ETHER_FROM_TSU_ADRH19 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH19) /* ETHER_FROM_TSU_ADRH19 */
#define ETHER_FROM_TSU_ADRH20 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH20) /* ETHER_FROM_TSU_ADRH20 */
#define ETHER_FROM_TSU_ADRH21 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH21) /* ETHER_FROM_TSU_ADRH21 */
#define ETHER_FROM_TSU_ADRH22 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH22) /* ETHER_FROM_TSU_ADRH22 */
#define ETHER_FROM_TSU_ADRH23 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH23) /* ETHER_FROM_TSU_ADRH23 */
#define ETHER_FROM_TSU_ADRH24 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH24) /* ETHER_FROM_TSU_ADRH24 */
#define ETHER_FROM_TSU_ADRH25 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH25) /* ETHER_FROM_TSU_ADRH25 */
#define ETHER_FROM_TSU_ADRH26 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH26) /* ETHER_FROM_TSU_ADRH26 */
#define ETHER_FROM_TSU_ADRH27 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH27) /* ETHER_FROM_TSU_ADRH27 */
#define ETHER_FROM_TSU_ADRH28 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH28) /* ETHER_FROM_TSU_ADRH28 */
#define ETHER_FROM_TSU_ADRH29 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH29) /* ETHER_FROM_TSU_ADRH29 */
#define ETHER_FROM_TSU_ADRH30 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH30) /* ETHER_FROM_TSU_ADRH30 */
#define ETHER_FROM_TSU_ADRH31 \
  (*(struct st_ether_from_tsu_adrh0*)&ETHER.TSU_ADRH31) /* ETHER_FROM_TSU_ADRH31 */
