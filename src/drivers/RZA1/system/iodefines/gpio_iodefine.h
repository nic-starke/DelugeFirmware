...
#define GPIO_FROM_PIPC1_ARRAY_ADDRESS_LIST                                                         \
  { /* ->MISRA 11.3 */ /* ->SEC R2.7.1 */                                                          \
    &GPIO_FROM_PIPC1, &GPIO_FROM_PIPC2, &GPIO_FROM_PIPC3, &GPIO_FROM_PIPC4, &GPIO_FROM_PIPC5,      \
        &GPIO_FROM_PIPC6, &GPIO_FROM_PIPC7, &GPIO_FROM_PIPC8, &GPIO_FROM_PIPC9, &GPIO_FROM_PIPC10, \
        &GPIO_FROM_PIPC11                                                                          \
...
#define GPIO_FROM_PBDC1_ARRAY_ADDRESS_LIST                                                         \
  { /* ->MISRA 11.3 */ /* ->SEC R2.7.1 */                                                          \
    &GPIO_FROM_PBDC1, &GPIO_FROM_PBDC2, &GPIO_FROM_PBDC3, &GPIO_FROM_PBDC4, &GPIO_FROM_PBDC5,      \
        &GPIO_FROM_PBDC6, &GPIO_FROM_PBDC7, &GPIO_FROM_PBDC8, &GPIO_FROM_PBDC9, &GPIO_FROM_PBDC10, \
        &GPIO_FROM_PBDC11                                                                          \
  } /* <-MISRA 11.3 */ /* <-SEC R2.7.1 */                            /* { } is for MISRA 19.4 */
...
#define GPIO_FROM_PIBC1_ARRAY_ADDRESS_LIST                                                         \
  { /* ->MISRA 11.3 */ /* ->SEC R2.7.1 */                                                          \
    &GPIO_FROM_PIBC1, &GPIO_FROM_PIBC2, &GPIO_FROM_PIBC3, &GPIO_FROM_PIBC4, &GPIO_FROM_PIBC5,      \
        &GPIO_FROM_PIBC6, &GPIO_FROM_PIBC7, &GPIO_FROM_PIBC8, &GPIO_FROM_PIBC9, &GPIO_FROM_PIBC10, \
        &GPIO_FROM_PIBC11                                                                          \
  } /* <-MISRA 11.3 */ /* <-SEC R2.7.1 */                            /* { } is for MISRA 19.4 */
...
#define GPIO_FROM_PFCAE1_ARRAY_ADDRESS_LIST                                                        \
  { /* ->MISRA 11.3 */ /* ->SEC R2.7.1 */                                                          \
    &GPIO_FROM_PFCAE1, &GPIO_FROM_PFCAE2, &GPIO_FROM_PFCAE3, &GPIO_FROM_PFCAE4, &GPIO_FROM_PFCAE5, \
        &GPIO_FROM_PFCAE6, &GPIO_FROM_PFCAE7, &GPIO_FROM_PFCAE8, &GPIO_FROM_PFCAE9,                \
        &GPIO_FROM_PFCAE10, &GPIO_FROM_PFCAE11                                                     \
  } /* <-MISRA 11.3 */ /* <-SEC R2.7.1 */                               /* { } is for MISRA 19.4 */
...
#define GPIO_FROM_PNOT1_ARRAY_ADDRESS_LIST                                                         \
  { /* ->MISRA 11.3 */ /* ->SEC R2.7.1 */                                                          \
    &GPIO_FROM_PNOT1, &GPIO_FROM_PNOT2, &GPIO_FROM_PNOT3, &GPIO_FROM_PNOT4, &GPIO_FROM_PNOT5,      \
        &GPIO_FROM_PNOT6, &GPIO_FROM_PNOT7, &GPIO_FROM_PNOT8, &GPIO_FROM_PNOT9, &GPIO_FROM_PNOT10, \
        &GPIO_FROM_PNOT11                                                                          \
  } /* <-MISRA 11.3 */ /* <-SEC R2.7.1 */                            /* { } is for MISRA 19.4 */
...
#define GPIO_FROM_PFCE1_ARRAY_ADDRESS_LIST                                                         \
  { /* ->MISRA 11.3 */ /* ->SEC R2.7.1 */                                                          \
    &GPIO_FROM_PFCE1, &GPIO_FROM_PFCE2, &GPIO_FROM_PFCE3, &GPIO_FROM_PFCE4, &GPIO_FROM_PFCE5,      \
        &GPIO_FROM_PFCE6, &GPIO_FROM_PFCE7, &GPIO_FROM_PFCE8, &GPIO_FROM_PFCE9, &GPIO_FROM_PFCE10, \
        &GPIO_FROM_PFCE11                                                                          \
  } /* <-MISRA 11.3 */ /* <-SEC R2.7.1 */                            /* { } is for MISRA 19.4 */
...
#define GPIO_FROM_PFC1_ARRAY_ADDRESS_LIST                                                     \
  { /* ->MISRA 11.3 */ /* ->SEC R2.7.1 */                                                     \
    &GPIO_FROM_PFC1, &GPIO_FROM_PFC2, &GPIO_FROM_PFC3, &GPIO_FROM_PFC4, &GPIO_FROM_PFC5,      \
        &GPIO_FROM_PFC6, &GPIO_FROM_PFC7, &GPIO_FROM_PFC8, &GPIO_FROM_PFC9, &GPIO_FROM_PFC10, \
        &GPIO_FROM_PFC11                                                                      \
  } /* <-MISRA 11.3 */ /* <-SEC R2.7.1 */                         /* { } is for MISRA 19.4 */
...
#define GPIO_FROM_PMC0_ARRAY_ADDRESS_LIST                                                    \
  { /* ->MISRA 11.3 */ /* ->SEC R2.7.1 */                                                    \
    &GPIO_FROM_PMC0, &GPIO_FROM_PMC1, &GPIO_FROM_PMC2, &GPIO_FROM_PMC3, &GPIO_FROM_PMC4,     \
        &GPIO_FROM_PMC5, &GPIO_FROM_PMC6, &GPIO_FROM_PMC7, &GPIO_FROM_PMC8, &GPIO_FROM_PMC9, \
        &GPIO_FROM_PMC10, &GPIO_FROM_PMC11                                                   \
  } /* <-MISRA 11.3 */ /* <-SEC R2.7.1 */                         /* { } is for MISRA 19.4 */
...
#define GPIO_FROM_PM1_ARRAY_ADDRESS_LIST                                                 \
  { /* ->MISRA 11.3 */ /* ->SEC R2.7.1 */                                                \
    &GPIO_FROM_PM1, &GPIO_FROM_PM2, &GPIO_FROM_PM3, &GPIO_FROM_PM4, &GPIO_FROM_PM5,      \
        &GPIO_FROM_PM6, &GPIO_FROM_PM7, &GPIO_FROM_PM8, &GPIO_FROM_PM9, &GPIO_FROM_PM10, \
        &GPIO_FROM_PM11                                                                  \
  } /* <-MISRA 11.3 */ /* <-SEC R2.7.1 */                      /* { } is for MISRA 19.4 */
...
#define GPIO_FROM_PPR0_ARRAY_ADDRESS_LIST                                                    \
  { /* ->MISRA 11.3 */ /* ->SEC R2.7.1 */                                                    \
    &GPIO_FROM_PPR0, &GPIO_FROM_PPR1, &GPIO_FROM_PPR2, &GPIO_FROM_PPR3, &GPIO_FROM_PPR4,     \
        &GPIO_FROM_PPR5, &GPIO_FROM_PPR6, &GPIO_FROM_PPR7, &GPIO_FROM_PPR8, &GPIO_FROM_PPR9, \
        &GPIO_FROM_PPR10, &GPIO_FROM_PPR11                                                   \
  } /* <-MISRA 11.3 */ /* <-SEC R2.7.1 */                         /* { } is for MISRA 19.4 */
...
#define GPIO_FROM_P1_ARRAY_ADDRESS_LIST                                                       \
  { /* ->MISRA 11.3 */ /* ->SEC R2.7.1 */                                                     \
    &GPIO_FROM_P1, &GPIO_FROM_P2, &GPIO_FROM_P3, &GPIO_FROM_P4, &GPIO_FROM_P5, &GPIO_FROM_P6, \
        &GPIO_FROM_P7, &GPIO_FROM_P8, &GPIO_FROM_P9, &GPIO_FROM_P10, &GPIO_FROM_P11           \
  } /* <-MISRA 11.3 */ /* <-SEC R2.7.1 */                 /* { } is for MISRA 19.4 */
...
#define GPIO_FROM_P10                                    \
  (*(struct st_gpio_from_p1*)&GPIO.P10) /* GPIO_FROM_P10 \
                                         */
#define GPIO_FROM_P11                                    \
  (*(struct st_gpio_from_p1*)&GPIO.P11) /* GPIO_FROM_P11 \
                                         */
