...
#define MLB_FROM_CECR0_ARRAY_ADDRESS_LIST                                                         \
  { /* ->MISRA 11.3 */ /* ->SEC R2.7.1 */                                                         \
    &MLB_FROM_CECR0, &MLB_FROM_CECR1, &MLB_FROM_CECR2, &MLB_FROM_CECR3, &MLB_FROM_CECR4,          \
        &MLB_FROM_CECR5, &MLB_FROM_CECR6, &MLB_FROM_CECR7, &MLB_FROM_CECR8, &MLB_FROM_CECR9,      \
        &MLB_FROM_CECR10, &MLB_FROM_CECR11, &MLB_FROM_CECR12, &MLB_FROM_CECR13, &MLB_FROM_CECR14, \
        &MLB_FROM_CECR15, &MLB_FROM_CECR16, &MLB_FROM_CECR17, &MLB_FROM_CECR18, &MLB_FROM_CECR19, \
        &MLB_FROM_CECR20, &MLB_FROM_CECR21, &MLB_FROM_CECR22, &MLB_FROM_CECR23, &MLB_FROM_CECR24, \
        &MLB_FROM_CECR25, &MLB_FROM_CECR26, &MLB_FROM_CECR27, &MLB_FROM_CECR28, &MLB_FROM_CECR29, \
        &MLB_FROM_CECR30                                                                          \
