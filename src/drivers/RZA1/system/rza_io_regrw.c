 ...
 *              :                           : Use register definition name of
 *the :                           : iodefine.h : uint16_t write_value      :
 *Write value for the IO register : uint16_t shift            : The number of
 *left shifts to the :                           : target bit : uint16_t mask :
 *Mask value for the IO register :                           : (Target bit :
 *"1") Return Value : None
 *******************************************************************************/
 ...
 *              :                           : Use register definition name of
 *the :                           : iodefine.h : uint32_t write_value      :
 *Write value for the IO register : uint32_t shift            : The number of
 *left shifts to the :                           : target bit : uint32_t mask :
 *Mask value for the IO register :                           : (Target bit :
 *"1") Return Value : None
 *******************************************************************************/
void RZA_IO_RegWrite_32(volatile uint32_t* ioreg,
 ...
 *              :                           : Use register definition name of
 *the :                           : iodefine.h : uint16_t shift            : The
 *number of right shifts to the :                           : target bit :
 *uint16_t mask             : Mask bit for the IO register : : (Target bit: "1")
 ...
 *              :                           : Use register definition name of
 *the :                           : iodefine.h : uint32_t shift            : The
 *number of right shifts to the :                           : target bit :
