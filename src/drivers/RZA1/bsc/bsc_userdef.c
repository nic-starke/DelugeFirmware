 ...
 *              : the NOR flash memory in the CS0 space is executed. Sets the
 *BSC : to connect the Spansion NOR flash memory S29GL512S10T to the : CS0 space
 *with 16-bit bus width. Arguments    : none Return Value : none
 ******************************************************************************/
 ...
 *              : space is required. In this sample code, the setting to use
 *              : the NOR flash memory in the CS1 space is executed. Sets the
 *BSC : to connect the Spansion NOR flash memory S29GL512S10T to the : CS1 space
 *with 16-bit bus width. Arguments    : none Return Value : none
 ******************************************************************************/
 ...
 * Return Value : none
 ******************************************************************************/
void userdef_bsc_cs4_init(void) { /* Add processing when using CS4 space */
}
 ...
 * Return Value : none
 ******************************************************************************/
void userdef_bsc_cs5_init(void) { /* Add processing when using CS5 space */
}
