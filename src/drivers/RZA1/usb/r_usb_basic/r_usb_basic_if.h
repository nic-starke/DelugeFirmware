 ...
 *                This file is the macrodefinition header file which a user can
 *operate.
 ***********************************************************************************************************************/
/**********************************************************************************************************************
...
typedef struct usb_utr {
  ...
  uint8_t      errcnt; /* Error count */ // This was being written to but never read
                                         // from, so I removed that code. Rohan
