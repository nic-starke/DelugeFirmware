 ...
 *
 * Copyright (C) 2014(2016) Renesas Electronics Corporation. All rights
 *reserved.
 ***********************************************************************************************************************/
/***********************************************************************************************************************
...
#define USB_DEV_B_NUM_CONFIGURATION         \
  (17u) /* Number of possible configuration \
         */
...
#define USB_DEV_I_CONFIGURATION                                                                \
  (6u)                             /* Index of string descriptor describing this configuration \
                                    */
...
#define USB_WAI_MSG(ID, MESS, TM) \
  (usb_cstd_wai_msg((uint8_t)(ID), (usb_msg_t*)(MESS), (usb_tm_t)(TM)))
#define USB_RCV_MSG(ID, MESS) (usb_cstd_rec_msg((uint8_t)(ID), (usb_msg_t**)(MESS), (usb_tm_t)(0u)))
#define USB_TRCV_MSG(ID, MESS, TM) \
  (usb_cstd_rec_msg((uint8_t)(ID), (usb_msg_t**)(MESS), (usb_tm_t)(TM)))
...
/* Number of software retries when a no-response condition occurs during a
 * transfer */
