 ...
 * USB_CFG_HHID_INT_IN      : Pipe number (USB_PIPE6 to USB_PIPE9) 1st Device
 * HID Interrupt In Pipe USB_CFG_HHID_INT_IN2     : Pipe number (USB_PIPE6 to
 * USB_PIPE9) 2nd Device HID Interrupt In Pipe USB_CFG_HHID_INT_IN3     : Pipe
 * number (USB_PIPE6 to USB_PIPE9) 3rd Device HID Interrupt In Pipe
 */
