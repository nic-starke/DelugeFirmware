...
******************************************************************************/
extern int32_t Userdef_SFLASH_Set_Mode(uint32_t    ch_no,
                                       uint32_t    dual,
                                       en_sf_req_t req,
                                       uint8_t     data_width,
                                       uint8_t     addr_mode);
 ...
 * Description  : Initialization in a basic part of a SPI multi-I/O bus
 *controller. : Serial flash memory is set as a Quad operation mode. Arguments
 *: uint32_t ch_no : use channel No uint32_t dual uint8_t  data_width uint8_t
 *spbr uint8_t  brdv uint8_t  addr_mode Return Value :  0 : success -1 : error
 ******************************************************************************/
int32_t R_SFLASH_Spimode_Init(uint32_t ch_no,
                              uint32_t dual,
                              uint8_t  data_width,
                              uint8_t  spbr,
                              uint8_t  brdv,
 ...
 * Description  : Initialization in a basic part of a SPI multi-I/O bus
 *controller. : Serial flash memory is set as a Quad operation mode. Arguments
 *: uint32_t ch_no : use channel No uint32_t dual st_spibsc_cfg_t *spibsccfg
 * Return Value :  0 : success
 *                -1 : error
 ******************************************************************************/
int32_t R_SFLASH_Exmode_Setting(uint32_t ch_no, uint32_t dual, st_spibsc_cfg_t* spibsccfg) {
  ...
  ret = Userdef_SFLASH_Set_Mode(ch_no,
                                dual,
                                req,
                                spibsccfg->udef_data_width,
