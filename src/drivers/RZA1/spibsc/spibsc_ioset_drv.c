...
int32_t spibsc_bsz_set(uint32_t ch_no, uint32_t bsz, uint8_t data_width) {
  ...
  if (RZA_IO_RegRead_32(&SPIBSC[ch_no]->CMNSR, SPIBSC_CMNSR_TEND_SHIFT, SPIBSC_CMNSR_TEND) !=
      SPIBSC_TRANS_END) {
    return -1;
  }
  ...
  if (RZA_IO_RegRead_32(&SPIBSC[ch_no]->CMNCR, SPIBSC_CMNCR_BSZ_SHIFT, SPIBSC_CMNCR_BSZ) != bsz) {
    if (bsz == SPIBSC_CMNCR_BSZ_DUAL) {
      ...
      if (io_spibsc_port_setting(ch_no, data_width, bsz) < 0) { return -1; }
    }

    RZA_IO_RegWrite_32(&SPIBSC[ch_no]->CMNCR, bsz, SPIBSC_CMNCR_BSZ_SHIFT, SPIBSC_CMNCR_BSZ);
    RZA_IO_RegWrite_32(&SPIBSC[ch_no]->DRCR,
                       SPIBSC_DRCR_RCF_EXE,
                       SPIBSC_DRCR_RCF_SHIFT,
                       SPIBSC_DRCR_RCF);
  }
 ...
 ******************************************************************************/
int32_t
spibsc_common_init(uint32_t ch_no, uint32_t bsz, uint8_t spbr, uint8_t brdv, uint8_t data_width) {
  if (ch_no > 1) { return -1; }
  ...
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->CMNCR,
                     SPIBSC_OUTPUT_HiZ,
                     SPIBSC_CMNCR_MOIIO3_SHIFT,
                     SPIBSC_CMNCR_MOIIO3);
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->CMNCR,
                     SPIBSC_OUTPUT_HiZ,
                     SPIBSC_CMNCR_MOIIO2_SHIFT,
                     SPIBSC_CMNCR_MOIIO2);
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->CMNCR,
                     SPIBSC_OUTPUT_HiZ,
                     SPIBSC_CMNCR_MOIIO1_SHIFT,
                     SPIBSC_CMNCR_MOIIO1);
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->CMNCR,
                     SPIBSC_OUTPUT_HiZ,
                     SPIBSC_CMNCR_MOIIO0_SHIFT,
                     SPIBSC_CMNCR_MOIIO0);

  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->CMNCR,
                     SPIBSC_OUTPUT_HiZ,
                     SPIBSC_CMNCR_IO3FV_SHIFT,
                     SPIBSC_CMNCR_IO3FV);
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->CMNCR,
                     SPIBSC_OUTPUT_HiZ,
                     SPIBSC_CMNCR_IO2FV_SHIFT,
                     SPIBSC_CMNCR_IO2FV);
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->CMNCR,
                     SPIBSC_OUTPUT_HiZ,
                     SPIBSC_CMNCR_IO0FV_SHIFT,
                     SPIBSC_CMNCR_IO0FV);
#endif
  ...
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->CMNCR,
                     ...
                     SPIBSC_CMNCR_CPHAT_SHIFT,
                     SPIBSC_CMNCR_CPHAT);
  /* even edge : read */
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->CMNCR,
                     SPIBSC_CMNCR_CPHAR_EVEN,
                     SPIBSC_CMNCR_CPHAR_SHIFT,
                     SPIBSC_CMNCR_CPHAR);
  /* SPBSSL   : low active */
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->CMNCR,
                     SPIBSC_CMNCR_SSLP_LOW,
                     SPIBSC_CMNCR_SSLP_SHIFT,
                     SPIBSC_CMNCR_SSLP);
  /* SPBCLK   : low at negate */
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->CMNCR,
                     SPIBSC_CMNCR_CPOL_LOW,
                     SPIBSC_CMNCR_CPOL_SHIFT,
                     SPIBSC_CMNCR_CPOL);

  spibsc_bsz_set(ch_no, bsz, data_width);

  /* next access delay */
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->SSLDR,
                     SPIBSC_DELAY_1SPBCLK,
                     SPIBSC_SSLDR_SPNDL_SHIFT,
                     SPIBSC_SSLDR_SPNDL);
  /* SPBSSL negate delay */
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->SSLDR,
                     SPIBSC_DELAY_1SPBCLK,
                     SPIBSC_SSLDR_SLNDL_SHIFT,
                     SPIBSC_SSLDR_SLNDL);
  /* clock delay */
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->SSLDR,
                     SPIBSC_DELAY_1SPBCLK,
                     SPIBSC_SSLDR_SCKDL_SHIFT,
                     SPIBSC_SSLDR_SCKDL);
...
void spibsc_wait_tend(uint32_t ch_no) {
  while (RZA_IO_RegRead_32(&SPIBSC[ch_no]->CMNSR, SPIBSC_CMNSR_TEND_SHIFT, SPIBSC_CMNSR_TEND) !=
         SPIBSC_TRANS_END) {
    routineForSD();
  }
 ...
 * Description  : The setting which makes a SPI multi-I/O bus controller
 *activate an outside address space read mode. Arguments    : uint32_t ch_no :
 *use channel No : st_spibsc_cfg_t *spibsccfg Return Value :  0 : success -1 :
 *error
 ******************************************************************************/
int32_t spibsc_dr_init(uint32_t ch_no, st_spibsc_cfg_t* spibsccfg) {
  ...
  /* SPI I/O mode */
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->CMNCR,
                     SPIBSC_CMNCR_MD_EXTRD,
                     SPIBSC_CMNCR_MD_SHIFT,
                     SPIBSC_CMNCR_MD);

  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->DRCR,
                     SPIBSC_BURST_2,
                     SPIBSC_DRCR_RBURST_SHIFT,
                     SPIBSC_DRCR_RBURST);
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->DRCR,
                     SPIBSC_BURST_ENABLE,
                     SPIBSC_DRCR_RBE_SHIFT,
                     SPIBSC_DRCR_RBE);
  /* Keep SSL after read  */
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->DRCR,
                     SPIBSC_SPISSL_KEEP,
                     SPIBSC_DRCR_SSLE_SHIFT,
                     SPIBSC_DRCR_SSLE);
  /* if not continuous address it negeted */

  /* ---- Command ---- */
  /* Command */
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->DRCMR,
                     spibsccfg->udef_cmd,
                     SPIBSC_DRCMR_CMD_SHIFT,
                     SPIBSC_DRCMR_CMD);
  /* Single */
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->DRENR,
                     spibsccfg->udef_cmd_width,
                     SPIBSC_DRENR_CDB_SHIFT,
                     SPIBSC_DRENR_CDB);
  /* Enable */
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->DRENR,
                     SPIBSC_OUTPUT_ENABLE,
                     SPIBSC_DRENR_CDE_SHIFT,
                     SPIBSC_DRENR_CDE);
  /* ---- Option Command ---- */
  ...
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->DRENR,
                     SPIBSC_1BIT,
                     SPIBSC_DRENR_OCDB_SHIFT,
                     SPIBSC_DRENR_OCDB);
  /* Disable */
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->DRENR,
                     SPIBSC_OUTPUT_DISABLE,
                     SPIBSC_DRENR_OCDE_SHIFT,
                     SPIBSC_DRENR_OCDE);

  /* ---- Address ---- */
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->DRENR,
                     spibsccfg->udef_addr_width,
                     SPIBSC_DRENR_ADB_SHIFT,
                     SPIBSC_DRENR_ADB);
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->DRENR,
                     spibsccfg->udef_addr_mode,
                     SPIBSC_DRENR_ADE_SHIFT,
                     SPIBSC_DRENR_ADE);
  ...
  /* ---- Option Data ---- */
  /* Option Data */
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->DROPR,
                     spibsccfg->udef_opd3,
                     SPIBSC_DROPR_OPD3_SHIFT,
                     SPIBSC_DROPR_OPD3);
  /* Option Data */
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->DROPR,
                     spibsccfg->udef_opd2,
                     SPIBSC_DROPR_OPD2_SHIFT,
                     SPIBSC_DROPR_OPD2);
  /* Option Data */
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->DROPR,
                     spibsccfg->udef_opd1,
                     SPIBSC_DROPR_OPD1_SHIFT,
                     SPIBSC_DROPR_OPD1);
  /* Option Data */
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->DROPR,
                     spibsccfg->udef_opd0,
                     SPIBSC_DROPR_OPD0_SHIFT,
                     SPIBSC_DROPR_OPD0);
  /* Single */
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->DRENR,
                     spibsccfg->udef_opd_width,
                     SPIBSC_DRENR_OPDB_SHIFT,
                     SPIBSC_DRENR_OPDB);
  /* Disable */
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->DRENR,
                     spibsccfg->udef_opd_enable,
                     SPIBSC_DRENR_OPDE_SHIFT,
                     SPIBSC_DRENR_OPDE);

  /* ---- Data ---- */
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->DRENR,
                     spibsccfg->udef_data_width,
                     SPIBSC_DRENR_DRDB_SHIFT,
                     SPIBSC_DRENR_DRDB);
  /* dummycycle enable */
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->DRENR,
                     spibsccfg->udef_dmycyc_enable,
                     SPIBSC_DRENR_DME_SHIFT,
                     SPIBSC_DRENR_DME);

  /* Set data read dummycycle */
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->DRDMCR,
                     spibsccfg->udef_dmycyc_width,
                     SPIBSC_DRDMCR_DMDB_SHIFT,
                     SPIBSC_SMDMCR_DMDB);
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->DRDMCR,
                     spibsccfg->udef_dmycyc_num,
                     SPIBSC_DRDMCR_DMCYC_SHIFT,
                     SPIBSC_DRDMCR_DMCYC);
  /* address:SDR */
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->DRDRENR,
                     SPIBSC_SDR_TRANS,
                     SPIBSC_DRDRENR_ADDRE_SHIFT,
                     SPIBSC_DRDRENR_ADDRE);
  /* option data:SDR */
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->DRDRENR,
                     SPIBSC_SDR_TRANS,
                     SPIBSC_DRDRENR_OPDRE_SHIFT,
                     SPIBSC_DRDRENR_OPDRE);
  /* data read: SDR */
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->DRDRENR,
                     SPIBSC_SDR_TRANS,
                     SPIBSC_DRDRENR_DRDRE_SHIFT,
                     SPIBSC_DRDRENR_DRDRE);
...
int32_t spibsc_exmode(uint32_t ch_no) {
  if (RZA_IO_RegRead_32(&SPIBSC[ch_no]->CMNCR, SPIBSC_CMNCR_MD_SHIFT, SPIBSC_CMNCR_MD) !=
      SPIBSC_CMNCR_MD_EXTRD) {
    if (spibsc_stop(ch_no) < 0) { return -1; }
...
int32_t spibsc_stop(uint32_t ch_no) {
  ...
  while (1) {
    if (RZA_IO_RegRead_32(&SPIBSC[ch_no]->CMNSR, SPIBSC_CMNSR_SSLF_SHIFT, SPIBSC_CMNSR_SSLF) ==
        SPIBSC_SSL_NEGATE) {
      break;
    }
  }
...
int32_t spibsc_transfer(uint32_t ch_no, st_spibsc_spimd_reg_t* regset) {
  ...
  if (regset->cde != SPIBSC_OUTPUT_DISABLE) {
    /* Command */
    RZA_IO_RegWrite_32(&SPIBSC[ch_no]->SMCMR,
                       regset->cmd,
                       SPIBSC_SMCMR_CMD_SHIFT,
                       SPIBSC_SMCMR_CMD);
    /* Single/Dual/Quad */
    RZA_IO_RegWrite_32(&SPIBSC[ch_no]->SMENR,
                       regset->cdb,
                       SPIBSC_SMENR_CDB_SHIFT,
                       SPIBSC_SMENR_CDB);
  }
  ...
  if (regset->ocde != SPIBSC_OUTPUT_DISABLE) {
    ...
    RZA_IO_RegWrite_32(&SPIBSC[ch_no]->SMCMR,
                       regset->ocmd,
                       SPIBSC_SMCMR_OCMD_SHIFT,
                       SPIBSC_SMCMR_OCMD);
    /* Single/Dual/Quad */
    RZA_IO_RegWrite_32(&SPIBSC[ch_no]->SMENR,
                       regset->ocdb,
                       SPIBSC_SMENR_OCDB_SHIFT,
                       SPIBSC_SMENR_OCDB);
  }
  ...
  if (regset->ade != SPIBSC_OUTPUT_DISABLE) {
    /* Address */
    RZA_IO_RegWrite_32(&SPIBSC[ch_no]->SMADR,
                       regset->addr,
                       SPIBSC_SMADR_ADR_SHIFT,
                       SPIBSC_SMADR_ADR);
    /* Single/Dual/Quad */
    RZA_IO_RegWrite_32(&SPIBSC[ch_no]->SMENR,
                       regset->adb,
                       SPIBSC_SMENR_ADB_SHIFT,
                       SPIBSC_SMENR_ADB);
  }
  ...
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->SMENR,
                     regset->opde,
                     SPIBSC_SMENR_OPDE_SHIFT,
                     SPIBSC_SMENR_OPDE);

  if (regset->opde != SPIBSC_OUTPUT_DISABLE) {
    /* Option Data */
    RZA_IO_RegWrite_32(&SPIBSC[ch_no]->SMOPR,
                       regset->opd[0],
                       SPIBSC_SMOPR_OPD3_SHIFT,
                       SPIBSC_SMOPR_OPD3);
    /* Option Data */
    RZA_IO_RegWrite_32(&SPIBSC[ch_no]->SMOPR,
                       regset->opd[1],
                       SPIBSC_SMOPR_OPD2_SHIFT,
                       SPIBSC_SMOPR_OPD2);
    /* Option Data */
    RZA_IO_RegWrite_32(&SPIBSC[ch_no]->SMOPR,
                       regset->opd[2],
                       SPIBSC_SMOPR_OPD1_SHIFT,
                       SPIBSC_SMOPR_OPD1);
    /* Option Data */
    RZA_IO_RegWrite_32(&SPIBSC[ch_no]->SMOPR,
                       regset->opd[3],
                       SPIBSC_SMOPR_OPD0_SHIFT,
                       SPIBSC_SMOPR_OPD0);
    /* Single/Dual/Quad */
    RZA_IO_RegWrite_32(&SPIBSC[ch_no]->SMENR,
                       regset->opdb,
                       SPIBSC_SMENR_OPDB_SHIFT,
                       SPIBSC_SMENR_OPDB);
  }
  ...
  if (regset->dme != SPIBSC_DUMMY_CYC_DISABLE) {
    RZA_IO_RegWrite_32(&SPIBSC[ch_no]->SMDMCR,
                       regset->dmdb,
                       SPIBSC_SMDMCR_DMDB_SHIFT,
                       SPIBSC_SMDMCR_DMDB);
    /* Dummy Cycle */
    RZA_IO_RegWrite_32(&SPIBSC[ch_no]->SMDMCR,
                       regset->dmcyc,
                       SPIBSC_SMDMCR_DMCYC_SHIFT,
                       SPIBSC_SMDMCR_DMCYC);
  }
  ...
  if (regset->spide != SPIBSC_OUTPUT_DISABLE) {
    ...
    RZA_IO_RegWrite_32(&SPIBSC[ch_no]->SMENR,
                       regset->spidb,
                       SPIBSC_SMENR_SPIDB_SHIFT,
                       SPIBSC_SMENR_SPIDB);
  }

  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->SMCR,
                     regset->sslkp,
                     SPIBSC_SMCR_SSLKP_SHIFT,
                     SPIBSC_SMCR_SSLKP);
  ...
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->SMCR,
                     regset->spire,
                     SPIBSC_SMCR_SPIRE_SHIFT,
                     SPIBSC_SMCR_SPIRE);
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->SMCR,
                     regset->spiwe,
                     SPIBSC_SMCR_SPIWE_SHIFT,
                     SPIBSC_SMCR_SPIWE);

  /* SDR Transmission/DDR Transmission Setting */
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->SMDRENR,
                     regset->addre,
                     SPIBSC_SMDRENR_ADDRE_SHIFT,
                     SPIBSC_SMDRENR_ADDRE);
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->SMDRENR,
                     regset->opdre,
                     SPIBSC_SMDRENR_OPDRE_SHIFT,
                     SPIBSC_SMDRENR_OPDRE);
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->SMDRENR,
                     regset->spidre,
                     SPIBSC_SMDRENR_SPIDRE_SHIFT,
                     SPIBSC_SMDRENR_SPIDRE);

  /* execute after setting SPNDL bit */
  RZA_IO_RegWrite_32(&SPIBSC[ch_no]->SMCR,
                     SPIBSC_SPI_ENABLE,
                     SPIBSC_SMCR_SPIE_SHIFT,
                     SPIBSC_SMCR_SPIE);
