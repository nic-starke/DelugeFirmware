...
void ssiInit(uint8_t ssiChannel, uint8_t dmaChannel) {
  ...
  initDMAWithLinkDescriptor(SSI_TX_DMA_CHANNEL,
                            ssiDmaTxLinkDescriptor,
                            DMARS_FOR_SSI0_TX + SSI_CHANNEL * 4);
#if DELUGE_MODEL != DELUGE_MODEL_40_PAD
  initDMAWithLinkDescriptor(SSI_RX_DMA_CHANNEL,
                            ssiDmaRxLinkDescriptor,
                            DMARS_FOR_SSI0_RX + SSI_CHANNEL * 4);
#endif
