...
#define SSI_SSICR0_DWL_VALUE \
  (0x00280000uL) // Was 0x00080000uL for 16-bit data word. Changed to
                 // 0x00280000uL for 24-bit. 0x00300000uL for 32-bit
// I don't understand why, but setting SWL to 16-bit is the only way to get
// things working, even for 24-bit data, and it appears that 24 correct bits are
// still being sent out
#define SSI_SSICR0_SWL_VALUE \
  (0x00030000uL) // Was 0x00030000uL for 32-bit system word. Changed to
                 // 0x00010000uL for 16-bit. 0x00020000uL for 24-bit
...
#define SSI_SSICR0_CKDV_VALUE \
  (0x00000020uL) // Original was 0x00000030uL - /8. 0x00000040uL is /16.
                 // 0x00000090uL is /12. 0x00000020uL is /4.
...
/*  [13]    SCKP    : B'0    : SSIWS and SSIDATA change at the SSISCK falling
 * edge              */
/*  [12]    SWSP    : B'0    : SSIWS is low for 1st channel, high for 2nd
 * channel               */
/*  [11]    SPDP    : B'0    : Padding bits are low */
/*  [10]    SDTA    : B'0    : Tx and Rx in the order of serial data and padding
 * bits           */
...
/*  [7:4]   CKDV    : B'0011 : AUDIO PHY/8 (64FS,AUDIO_X1@22.5792MHz/32bit
 * system word)         */
