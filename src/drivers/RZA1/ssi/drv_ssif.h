...
#define SSI_SSIFCR_TTRG_INIT_VALUE \
  (0x000000A0uL) // By Rohan - I made it 0x000000C0uL, but have now given up on
                 // that
#define SSI_SSIFCR_BASE_INIT_VALUE                                                       \
  (SSI_SSIFCR_TIE_INIT_VALUE | SSI_SSIFCR_RIE_INIT_VALUE | SSI_SSIFCR_TFRST_INIT_VALUE | \
   SSI_SSIFCR_TTRG_INIT_VALUE | SSI_SSIFCR_RFRST_INIT_VALUE)
